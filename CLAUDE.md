...
Ultimate Brain MCP is a Python MCP (Model Context Protocol) server that exposes Thomas Frank's Ultimate Brain Notion system as 48 tools for AI assistants. Built on Anthropic's FastMCP SDK with async httpx for Notion API calls.

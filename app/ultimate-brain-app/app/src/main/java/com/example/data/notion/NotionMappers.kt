...
object NotionMappers {
  ...
  fun toTask(
    ...
    return Task(
      ...
      occurrenceIds = p.prop("Occurrences").rel(),
  ...
  fun toProject(
    ...
    return ProjectModel(
      ...
      deadlineIso = p.prop("Target Deadline")?.dateStart()?.substringBefore('T'),
  ...
  fun toNote(
    ...
    return NoteModel(
      ...
      dateIso = p.prop("Note Date")?.dateStart()?.substringBefore('T'),
      projectName = projectIds.firstNotNullOfOrNull { projectNames[it] },
